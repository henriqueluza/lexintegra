...
- **`reservada_sem_link` é estado desenhado, não exceção** — com a integração desligada, *toda* reunião nasce assim. O painel do admin as lista com o id do registro do outbox, e o botão de tentar de novo reenvia **aquele** registro pelo caminho normal (regra 3).
